        ...
        <CardContent className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              {showParticipants && (
                <div className="absolute z-10 w-full mt-2 p-2 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 shadow-xl animate-in fade-in slide-in-from-top-2 duration-200">
